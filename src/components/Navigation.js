...
function Navigation() {
    return (
        <nav id="navigation">
            <ul>
                <li><NavLink to="/" exact activeStyle={{ 'backgroundColor':'hsl(219, 86%, 54%)','color':'hsl(0, 0%, 100%)' }}>Home</NavLink></li>
                <li><hr/></li>
                ...
                <li><hr/></li>
                <li><NavLink to="/s/result" exact activeStyle={{ 'backgroundColor':'hsl(123, 72%, 48%)','color':'hsl(0, 0%, 100%)' }}>Result</NavLink></li>
            </ul>
        </nav>
    );
}
