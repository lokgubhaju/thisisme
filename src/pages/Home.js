    ...
    return (
        <header id="header">
            ...
            <ul>
                ...
                <li><a href="https://github.com/JoseDeFreitas/thisisme/blob/main/contribute.md" target="_blank" rel="noopener noreferrer">Contribute</a></li>
            </ul>
        </header>
    );
}
